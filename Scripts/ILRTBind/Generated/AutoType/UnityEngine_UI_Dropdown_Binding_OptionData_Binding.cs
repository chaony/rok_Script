...
{
    unsafe class UnityEngine_UI_Dropdown_Binding_OptionData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.UI.Dropdown.OptionData);
            args = new Type[]{};
        ...
        static StackObject* get_text_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.UI.Dropdown.OptionData instance_of_this_method = (UnityEngine.UI.Dropdown.OptionData)typeof(UnityEngine.UI.Dropdown.OptionData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.UI.Dropdown.OptionData(@text);
