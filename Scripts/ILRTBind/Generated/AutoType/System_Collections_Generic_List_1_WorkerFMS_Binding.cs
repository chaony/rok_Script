...
{
    unsafe class System_Collections_Generic_List_1_WorkerFMS_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<Client.FSM.WorkerFMS>);
            args = new Type[]{};
        ...
        static StackObject* GetEnumerator_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<Client.FSM.WorkerFMS> instance_of_this_method = (System.Collections.Generic.List<Client.FSM.WorkerFMS>)typeof(System.Collections.Generic.List<Client.FSM.WorkerFMS>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Add_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Client.FSM.WorkerFMS @item = (Client.FSM.WorkerFMS)typeof(Client.FSM.WorkerFMS).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<Client.FSM.WorkerFMS>();
