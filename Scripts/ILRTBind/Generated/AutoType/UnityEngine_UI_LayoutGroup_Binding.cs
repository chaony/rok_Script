...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_LayoutGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetLayoutHorizontal_0);
            args = new Type[]{};
            method = type.GetMethod("SetLayoutVertical", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetLayoutVertical_1);
            args = new Type[]{};
            method = type.GetMethod("get_padding", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_padding_2);
            args = new Type[]{};
            method = type.GetMethod("CalculateLayoutInputVertical", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateLayoutInputVertical_3);
            args = new Type[]{};
            method = type.GetMethod("get_preferredHeight", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_preferredHeight_4);


        }


        static StackObject* SetLayoutHorizontal_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* SetLayoutVertical_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_padding_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_preferredHeight_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
