...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_GridLayoutGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_constraintCount_0);
            args = new Type[]{};
            method = type.GetMethod("get_cellSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_cellSize_1);
            args = new Type[]{};
            method = type.GetMethod("get_spacing", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_spacing_2);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("set_constraintCount", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_constraintCount_3);
            args = new Type[]{typeof(UnityEngine.Vector2)};
            method = type.GetMethod("set_cellSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_cellSize_4);


        }


        static StackObject* get_constraintCount_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_cellSize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_spacing_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_constraintCount_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_cellSize_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
