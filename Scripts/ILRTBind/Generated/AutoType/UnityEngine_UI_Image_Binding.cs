...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Image_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_sprite_0);
            args = new Type[]{};
            method = type.GetMethod("get_sprite", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_sprite_1);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_fillAmount", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_fillAmount_2);
        ...
        static StackObject* get_sprite_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_fillAmount_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
