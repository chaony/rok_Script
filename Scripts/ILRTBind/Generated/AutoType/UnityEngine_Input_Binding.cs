...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Input_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetKeyUp_0);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetMouseButtonDown", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetMouseButtonDown_1);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, GetMouseButtonUp_3);
            args = new Type[]{};
            method = type.GetMethod("get_touchCount", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_touchCount_4);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetTouch", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetTouch_5);
            args = new Type[]{typeof(UnityEngine.KeyCode)};
            method = type.GetMethod("GetKeyDown", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetKeyDown_6);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetMouseButton", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetMouseButton_7);


        }


        static StackObject* GetKeyUp_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* GetMouseButtonDown_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetMouseButtonUp_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_touchCount_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* GetTouch_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetKeyDown_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetMouseButton_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
