...
{
    unsafe class System_Collections_Generic_List_1_ManorItem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<global::ManorItem>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.Action<global::ManorItem>)};
            method = type.GetMethod("ForEach", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ForEach_2);
            args = new Type[]{typeof(System.Collections.Generic.IEnumerable<global::ManorItem>)};
            ...
            app.RegisterCLRMethodRedirection(method, Contains_4);
            args = new Type[]{typeof(global::ManorItem)};
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<global::ManorItem> instance_of_this_method = (System.Collections.Generic.List<global::ManorItem>)typeof(System.Collections.Generic.List<global::ManorItem>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* ForEach_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<global::ManorItem> @action = (System.Action<global::ManorItem>)typeof(System.Action<global::ManorItem>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* AddRange_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<global::ManorItem> @collection = (System.Collections.Generic.IEnumerable<global::ManorItem>)typeof(System.Collections.Generic.IEnumerable<global::ManorItem>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Contains_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            global::ManorItem @item = (global::ManorItem)typeof(global::ManorItem).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<global::ManorItem>();
