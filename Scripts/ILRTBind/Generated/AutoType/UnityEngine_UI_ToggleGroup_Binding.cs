...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_ToggleGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_allowSwitchOff_0);
            args = new Type[]{};
            method = type.GetMethod("AnyTogglesOn", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, AnyTogglesOn_1);


        }


        static StackObject* set_allowSwitchOff_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* AnyTogglesOn_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
