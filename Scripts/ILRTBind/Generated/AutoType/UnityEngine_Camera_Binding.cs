...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Camera_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("WorldToViewportPoint", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WorldToViewportPoint_1);
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("ScreenPointToRay", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ScreenPointToRay_2);
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("ViewportPointToRay", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ViewportPointToRay_3);
        ...
        static StackObject* WorldToScreenPoint_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.WorldToScreenPoint(@position);
        ...
        static StackObject* WorldToViewportPoint_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.WorldToViewportPoint(@position);
        ...
        static StackObject* ScreenPointToRay_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* ViewportPointToRay_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.ViewportPointToRay(@pos);
