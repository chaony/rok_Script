...
{
    unsafe class Skyunion_ILogService_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Skyunion.ILogService);
            ...
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Warn", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Warn_2);
            args = new Type[]{typeof(System.String), typeof(UnityEngine.Color)};
        ...
        static StackObject* Error_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Skyunion.ILogService instance_of_this_method = (Skyunion.ILogService)typeof(Skyunion.ILogService).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Error(@message);
        ...
        static StackObject* Debug_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Debug(@message, @color);

            return __ret;
        }

        static StackObject* Warn_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.Warn(@message);
        ...
        static StackObject* Info_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Info(@message, @color);
        ...
        static StackObject* Info_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Info(@message);
        ...
        static StackObject* Debug_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Debug(@message);
