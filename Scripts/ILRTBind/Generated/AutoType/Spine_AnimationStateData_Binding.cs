...
{
    unsafe class Spine_AnimationStateData_Binding
    {
        ...
        static StackObject* get_SkeletonData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Spine.AnimationStateData instance_of_this_method = (Spine.AnimationStateData)typeof(Spine.AnimationStateData).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
