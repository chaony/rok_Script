...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_ParticleSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_time_0);
            args = new Type[]{};
        ...
        static StackObject* set_time_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
