...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_CharacterInfo_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityEngine.CharacterInfo instance_of_this_method)
        {
        ...
        static StackObject* get_advance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.CharacterInfo instance_of_this_method = (UnityEngine.CharacterInfo)typeof(UnityEngine.CharacterInfo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
