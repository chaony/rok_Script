...
{
    unsafe class System_Collections_Generic_Stack_1_KeyCode_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Stack<UnityEngine.KeyCode>);
            ...
            app.RegisterCLRMethodRedirection(method, Peek_1);
            args = new Type[]{};
        ...
        static StackObject* Push_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.KeyCode @item = (UnityEngine.KeyCode)typeof(UnityEngine.KeyCode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.Stack<UnityEngine.KeyCode> instance_of_this_method = (System.Collections.Generic.Stack<UnityEngine.KeyCode>)typeof(System.Collections.Generic.Stack<UnityEngine.KeyCode>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.KeyCode>();
