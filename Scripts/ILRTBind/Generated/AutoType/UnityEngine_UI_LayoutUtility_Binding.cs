...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_LayoutUtility_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetPreferredHeight_0);


        }


        static StackObject* GetPreferredHeight_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
