...
{
    unsafe class System_Collections_Generic_Dictionary_2_Int32_MarchLine_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.Int32, Client.MarchLine>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.Int32), typeof(Client.MarchLine).MakeByRefType()};
            ...
            args = new Type[]{typeof(System.Int32), typeof(Client.MarchLine)};
        ...
        static StackObject* get_Values_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.Int32, Client.MarchLine> instance_of_this_method = (System.Collections.Generic.Dictionary<System.Int32, Client.MarchLine>)typeof(System.Collections.Generic.Dictionary<System.Int32, Client.MarchLine>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* TryGetValue_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Client.MarchLine @value = (Client.MarchLine)typeof(Client.MarchLine).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Client.MarchLine[];
        ...
        static StackObject* Add_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Client.MarchLine @value = (Client.MarchLine)typeof(Client.MarchLine).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.Int32, Client.MarchLine>();
