...
{
    unsafe class System_Collections_Generic_Dictionary_2_Int64_RectTransform_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.Int64, UnityEngine.RectTransform>);
            args = new Type[]{typeof(System.Int64), typeof(UnityEngine.RectTransform)};
            method = type.GetMethod("set_Item", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_Item_0);
            args = new Type[]{typeof(System.Int64), typeof(UnityEngine.RectTransform).MakeByRefType()};
        ...
        static StackObject* set_Item_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.Int64, UnityEngine.RectTransform> instance_of_this_method = (System.Collections.Generic.Dictionary<System.Int64, UnityEngine.RectTransform>)typeof(System.Collections.Generic.Dictionary<System.Int64, UnityEngine.RectTransform>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.RectTransform @value = (UnityEngine.RectTransform)typeof(UnityEngine.RectTransform).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.Int64, UnityEngine.RectTransform>();
