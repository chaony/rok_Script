...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Shader_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetGlobalFloat_0);


        }


        static StackObject* SetGlobalFloat_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
