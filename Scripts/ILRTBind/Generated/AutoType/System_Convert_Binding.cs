...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Convert_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ToInt64_2);
            args = new Type[]{typeof(System.Byte[])};
            method = type.GetMethod("ToBase64String", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToBase64String_3);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("FromBase64String", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FromBase64String_4);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ToInt32", flag, null, args, null);
        ...
        static StackObject* ToInt64_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ToBase64String_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* FromBase64String_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
