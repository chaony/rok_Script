...
{
    unsafe class System_Action_1_SprotoTypeBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Action<Sproto.SprotoTypeBase>);
            args = new Type[]{typeof(Sproto.SprotoTypeBase)};
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<Sproto.SprotoTypeBase> instance_of_this_method = (System.Action<Sproto.SprotoTypeBase>)typeof(System.Action<Sproto.SprotoTypeBase>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
