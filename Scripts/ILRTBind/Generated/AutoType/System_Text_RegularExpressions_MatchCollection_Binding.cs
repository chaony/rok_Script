...
{
    unsafe class System_Text_RegularExpressions_MatchCollection_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Text.RegularExpressions.MatchCollection);
        ...
        static StackObject* get_Item_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Text.RegularExpressions.MatchCollection instance_of_this_method = (System.Text.RegularExpressions.MatchCollection)typeof(System.Text.RegularExpressions.MatchCollection).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
