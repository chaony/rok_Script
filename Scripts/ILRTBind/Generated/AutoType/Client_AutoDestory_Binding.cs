...
{
    unsafe class Client_AutoDestory_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Client.AutoDestory);
        ...
        {
            ((Client.AutoDestory)o).time = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_time_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((Client.AutoDestory)o).time = @time;
