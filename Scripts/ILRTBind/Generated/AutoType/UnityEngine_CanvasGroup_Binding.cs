...
{
    unsafe class UnityEngine_CanvasGroup_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_alpha_0);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_alpha", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_alpha_1);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_interactable", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_interactable_2);


        }


        static StackObject* get_alpha_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_interactable_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
