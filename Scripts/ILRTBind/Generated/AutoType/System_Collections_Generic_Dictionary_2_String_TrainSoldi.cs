...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_TrainSoldiersFMS_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, Client.FSM.TrainSoldiersFMS>);
            ...
            args = new Type[]{typeof(System.String), typeof(Client.FSM.TrainSoldiersFMS)};
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, Client.FSM.TrainSoldiersFMS> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, Client.FSM.TrainSoldiersFMS>)typeof(System.Collections.Generic.Dictionary<System.String, Client.FSM.TrainSoldiersFMS>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Add_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Client.FSM.TrainSoldiersFMS @value = (Client.FSM.TrainSoldiersFMS)typeof(Client.FSM.TrainSoldiersFMS).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.String, Client.FSM.TrainSoldiersFMS>();
