...
{
    unsafe class System_Collections_Generic_List_1_Skyunion_GameViewAdaptor_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<Skyunion.GameViewAdaptor.Adaptor>);
            args = new Type[]{typeof(Skyunion.GameViewAdaptor.Adaptor)};
        ...
        static StackObject* Add_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Skyunion.GameViewAdaptor.Adaptor @item = (Skyunion.GameViewAdaptor.Adaptor)typeof(Skyunion.GameViewAdaptor.Adaptor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.List<Skyunion.GameViewAdaptor.Adaptor> instance_of_this_method = (System.Collections.Generic.List<Skyunion.GameViewAdaptor.Adaptor>)typeof(System.Collections.Generic.List<Skyunion.GameViewAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<Skyunion.GameViewAdaptor.Adaptor>();
