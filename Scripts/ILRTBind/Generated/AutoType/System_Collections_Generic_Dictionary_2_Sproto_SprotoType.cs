...
{
    unsafe class System_Collections_Generic_Dictionary_2_Sproto_SprotoTypeBaseAdaptor_Binding_Adaptor_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<Sproto.SprotoTypeBaseAdaptor.Adaptor, System.Int32>);
            args = new Type[]{typeof(Sproto.SprotoTypeBaseAdaptor.Adaptor), typeof(System.Int32).MakeByRefType()};
            method = type.GetMethod("TryGetValue", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TryGetValue_0);
            args = new Type[]{typeof(Sproto.SprotoTypeBaseAdaptor.Adaptor), typeof(System.Int32)};
        ...
        static StackObject* TryGetValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Sproto.SprotoTypeBaseAdaptor.Adaptor @key = (Sproto.SprotoTypeBaseAdaptor.Adaptor)typeof(Sproto.SprotoTypeBaseAdaptor.Adaptor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            System.Collections.Generic.Dictionary<Sproto.SprotoTypeBaseAdaptor.Adaptor, System.Int32> instance_of_this_method = (System.Collections.Generic.Dictionary<Sproto.SprotoTypeBaseAdaptor.Adaptor, System.Int32>)typeof(System.Collections.Generic.Dictionary<Sproto.SprotoTypeBaseAdaptor.Adaptor, System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<Sproto.SprotoTypeBaseAdaptor.Adaptor, System.Int32>();
