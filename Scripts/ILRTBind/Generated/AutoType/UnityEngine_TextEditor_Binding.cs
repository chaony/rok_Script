...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_TextEditor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SelectAll_0);
            args = new Type[]{};
        ...
        static StackObject* SelectAll_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.TextEditor instance_of_this_method = (UnityEngine.TextEditor)typeof(UnityEngine.TextEditor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
