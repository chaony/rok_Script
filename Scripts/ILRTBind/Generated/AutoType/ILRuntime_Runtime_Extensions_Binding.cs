...
{
    unsafe class ILRuntime_Runtime_Extensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Runtime.Extensions);
        ...
        static StackObject* ToInt64_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Runtime.Extensions.ToInt64(@obj);
        ...
        static StackObject* ToInt32_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ILRuntime.Runtime.Extensions.ToInt32(@obj);
