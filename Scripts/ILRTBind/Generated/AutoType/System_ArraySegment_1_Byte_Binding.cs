...
{
    unsafe class System_ArraySegment_1_Byte_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.ArraySegment<System.Byte>);
            args = new Type[]{};
            method = type.GetMethod("get_Count", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Count_0);
            args = new Type[]{};
            method = type.GetMethod("get_Offset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Offset_1);
            args = new Type[]{};
            method = type.GetMethod("get_Array", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Array_2);

            app.RegisterCLRCreateDefaultInstance(type, () => new System.ArraySegment<System.Byte>());
        ...
        static StackObject* get_Offset_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
