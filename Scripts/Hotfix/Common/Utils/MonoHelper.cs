...
namespace Game
{
    public class MonoHelper
    {
        ...
        public static T[] GetHotFixViewComponentsInChildren<T>(GameObject go) where T : GameView, new()
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                T fixCp = GetOrAddHotFixViewComponent<T>(subGo.gameObject);
        ...
        public static T CloneObject<T>(T obj)
        {
            ...
            var props = type.GetProperties(BindingFlags.Public | BindingFlags.Instance | BindingFlags.SetProperty | BindingFlags.GetProperty);
            var fields = type.GetFields(BindingFlags.Public | BindingFlags.Instance | BindingFlags.SetProperty | BindingFlags.GetProperty);
            ...
            {
                var field = fields[i];
                field.SetValue(ret, field.GetValue(obj));
            }
