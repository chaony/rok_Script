...
// Class Description   :    UI_Win_MonumentAllianceShowView
...
namespace Game {
    public class UI_Win_MonumentAllianceShowView : GameView
    {
        public const string VIEW_NAME = "UI_Win_MonumentAllianceShow";

        public UI_Win_MonumentAllianceShowView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_MonumentAllianceShowMediator mt = new UI_Win_MonumentAllianceShowMediator(vb.gameObject);
            mt.view = this;
