...
// Class Description   :    UI_Win_SettingNoticeView
...
namespace Game {
    public class UI_Win_SettingNoticeView : GameView
    {
        public const string VIEW_NAME = "UI_Win_SettingNotice";

        public UI_Win_SettingNoticeView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_SettingNoticeMediator mt = new UI_Win_SettingNoticeMediator(vb.gameObject);
            mt.view = this;
