...
// Class Description   :    UI_Pop_IconOnMysteryStoreView
...
namespace Game {
    public class UI_Pop_IconOnMysteryStoreView : GameView
    {
		public const string VIEW_NAME = "UI_Pop_IconOnMysteryStore";

        public UI_Pop_IconOnMysteryStoreView () 
        {
        }
