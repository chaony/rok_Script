...
// Class Description   :    UI_Win_WarView
...
namespace Game {
    public class UI_Win_WarView : GameView
    {
        public const string VIEW_NAME = "UI_Win_War";

        public UI_Win_WarView () 
        {
        }
		...
		[HideInInspector] public LanguageText m_lbl_safe_LanguageText;
        ...
        private void UIFinder()
        {
			...
			m_lbl_safe_LanguageText = FindUI<LanguageText>(vb.transform ,"rect/lbl_safe");
            ...
            UI_Win_WarMediator mt = new UI_Win_WarMediator(vb.gameObject);
            mt.view = this;
