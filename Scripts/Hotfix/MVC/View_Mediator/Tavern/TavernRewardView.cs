...
// Class Description   :    TavernRewardView
...
namespace Game {
    public class TavernRewardView : GameView
    {
        public const string VIEW_NAME = "UI_Win_TavernReward";

        public TavernRewardView () 
        {
        }
        ...
        private void UIFinder()
        {
			...
			m_lbl_title_Shadow = FindUI<Shadow>(vb.transform ,"lbl_title");
			...
			m_UI_sure = new UI_Model_StandardButton_Blue_sure_SubView(FindUI<RectTransform>(vb.transform ,"UI_sure"));
			m_lbl_desc_LanguageText = FindUI<LanguageText>(vb.transform ,"lbl_desc");


            TavernRewardMediator mt = new TavernRewardMediator(vb.gameObject);
            mt.view = this;
