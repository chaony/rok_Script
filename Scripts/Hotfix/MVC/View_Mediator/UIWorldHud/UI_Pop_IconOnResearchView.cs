...
// Class Description   :    UI_Pop_IconOnResearchView
...
namespace Game {
    public class UI_Pop_IconOnResearchView : GameView
    {
		public const string VIEW_NAME = "UI_Pop_IconOnResearch";

        public UI_Pop_IconOnResearchView () 
        {
        }
        ...
        private void UIFinder(GameObject obj)
        {
			...
			m_img_rare_PolygonImage = FindUI<PolygonImage>(vb.transform ,"pl_offset/pl_arrow/pl_size/img_rare");
