...
// Class Description   :    UI_Win_PlayerManageView
...
namespace Game {
    public class UI_Win_PlayerManageView : GameView
    {
        public const string VIEW_NAME = "UI_Win_PlayerManage";

        public UI_Win_PlayerManageView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_PlayerManageMediator mt = new UI_Win_PlayerManageMediator(vb.gameObject);
            mt.view = this;
