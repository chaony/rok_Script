...
// Class Description   :    UI_Pop_IconOnTheWallView
...
namespace Game {
    public class UI_Pop_IconOnTheWallView : GameView
    {
		public const string VIEW_NAME = "UI_Pop_IconOnTheWall";

        public UI_Pop_IconOnTheWallView () 
        {
        }
