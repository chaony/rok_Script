...
// Class Description   :    UI_Pop_IconOnVipView
...
namespace Game {
    public class UI_Pop_IconOnVipView : GameView
    {
		public const string VIEW_NAME = "UI_Pop_IconOnVip";

        public UI_Pop_IconOnVipView () 
        {
        }
