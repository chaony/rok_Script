...
// Class Description   :    UI_Pop_IconOnMonumentView
...
namespace Game {
    public class UI_Pop_IconOnMonumentView : GameView
    {
		public const string VIEW_NAME = "UI_Pop_IconOnMonument";

        public UI_Pop_IconOnMonumentView () 
        {
        }
