...
// Class Description   :    UI_Pop_WorldObjectVillageCaveView
...
namespace Game {
    public class UI_Pop_WorldObjectVillageCaveView : GameView
    {
        public const string VIEW_NAME = "UI_Pop_WorldObjectVillageCave";

        public UI_Pop_WorldObjectVillageCaveView () 
        {
        }
        ...
        private void UIFinder()
        {
			...
			m_UI_Model_StandardButton_Yellow = new UI_Model_DoubleLineButton_Yellow2_SubView(FindUI<RectTransform>(vb.transform ,"pl_pos/pl_content/img_bg/rect/standard/btns/UI_Model_StandardButton_Yellow"));
			...
			m_UI_Model_RewardGet = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(vb.transform ,"pl_pos/pl_content/img_bg/rect/pl_normalInfo/pl_villageReward/UI_Model_RewardGet"));
			...
			m_UI_Common_PopFun = new UI_Common_PopFun_SubView(FindUI<RectTransform>(vb.transform ,"pl_pos/pl_content/img_bg/rect/UI_Common_PopFun"));

            UI_Pop_WorldObjectVillageCaveMediator mt = new UI_Pop_WorldObjectVillageCaveMediator(vb.gameObject);
            mt.view = this;
