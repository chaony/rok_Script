// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Item_ArmyBuffCaptainL_SubView
...
namespace Game {
    public partial class UI_Item_ArmyBuffCaptainL_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Item_ArmyBuffCaptainL";

        public UI_Item_ArmyBuffCaptainL_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Item_ArmyBuffCaptainL;
        ...
        {       
			m_UI_Item_ArmyBuffCaptainL = gameObject.GetComponent<RectTransform>();
