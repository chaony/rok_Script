...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_ImgBtn_Blue";

        public UI_Model_ImgBtn_Blue_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_ImgBtn_Blue;
        ...
        {       
			m_UI_Model_ImgBtn_Blue = gameObject.GetComponent<RectTransform>();
