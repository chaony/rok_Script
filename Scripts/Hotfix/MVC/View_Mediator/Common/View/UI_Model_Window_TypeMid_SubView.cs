...
namespace Game {
    public partial class UI_Model_Window_TypeMid_SubView : UI_SubView
    {
        ...
        {       
			...
			m_btn_close_BtnAnimation = FindUI<BtnAnimation>(gameObject.transform ,"bg/btn_close");
			...
			m_btn_back_BtnAnimation = FindUI<BtnAnimation>(gameObject.transform ,"bg/btn_back");
