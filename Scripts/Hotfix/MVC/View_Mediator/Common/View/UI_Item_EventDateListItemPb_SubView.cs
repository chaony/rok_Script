...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Item_EventDateListItemPb";

        public UI_Item_EventDateListItemPb_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public ViewBinder m_UI_Item_EventDateListItemPb_ViewBinder;
		[HideInInspector] public ArabLayoutCompment m_UI_Item_EventDateListItemPb_ArabLayoutCompment;

		[HideInInspector] public GameButton m_btn_click_GameButton;
		[HideInInspector] public Empty4Raycast m_btn_click_Empty4Raycast;
		[HideInInspector] public ArabLayoutCompment m_btn_click_ArabLayoutCompment;
        ...
        {       
			m_UI_Item_EventDateListItemPb_ViewBinder = gameObject.GetComponent<ViewBinder>();
			m_UI_Item_EventDateListItemPb_ArabLayoutCompment = gameObject.GetComponent<ArabLayoutCompment>();
			...
			m_btn_click_ArabLayoutCompment = FindUI<ArabLayoutCompment>(gameObject.transform ,"btn_click");
			...
			m_pb_rogressBar0_GameSlider = FindUI<GameSlider>(gameObject.transform ,"btn_click/pb_rogressBar0");
			m_pb_rogressBar0_ArabLayoutCompment = FindUI<ArabLayoutCompment>(gameObject.transform ,"btn_click/pb_rogressBar0");

			m_pb_rogressBar_GameSlider = FindUI<GameSlider>(gameObject.transform ,"btn_click/pb_rogressBar");
			m_pb_rogressBar_ArabLayoutCompment = FindUI<ArabLayoutCompment>(gameObject.transform ,"btn_click/pb_rogressBar");
