...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_DoubleLineButton_Red2";

        public UI_Model_DoubleLineButton_Red2_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_DoubleLineButton_Red2;
        ...
        {       
			m_UI_Model_DoubleLineButton_Red2 = gameObject.GetComponent<RectTransform>();
