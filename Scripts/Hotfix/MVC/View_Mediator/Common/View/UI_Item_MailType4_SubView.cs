// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Item_MailType4_SubView
...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Item_MailType4";

        public UI_Item_MailType4_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public VerticalLayoutGroup m_UI_Item_MailType4_VerticalLayoutGroup;
		[HideInInspector] public ViewBinder m_UI_Item_MailType4_ViewBinder;
        ...
        {       
			m_UI_Item_MailType4_VerticalLayoutGroup = gameObject.GetComponent<VerticalLayoutGroup>();
			m_UI_Item_MailType4_ViewBinder = gameObject.GetComponent<ViewBinder>();
