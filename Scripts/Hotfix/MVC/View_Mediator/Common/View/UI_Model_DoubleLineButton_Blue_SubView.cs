// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Model_DoubleLineButton_Blue_SubView
...
namespace Game {
    public partial class UI_Model_DoubleLineButton_Blue_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Model_DoubleLineButton_Blue";

        public UI_Model_DoubleLineButton_Blue_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_DoubleLineButton_Blue;
		...
		[HideInInspector] public LayoutElement m_img_redpoint_LayoutElement;



        private void UIFinder()
        {       
			m_UI_Model_DoubleLineButton_Blue = gameObject.GetComponent<RectTransform>();
			...
			m_lbl_line1_LanguageText = FindUI<LanguageText>(gameObject.transform ,"btn_languageButton/lbl_line1");
			m_lbl_line1_Shadow = FindUI<Shadow>(gameObject.transform ,"btn_languageButton/lbl_line1");
			...
			m_img_redpoint_LayoutElement = FindUI<LayoutElement>(gameObject.transform ,"btn_languageButton/img_redpoint");
