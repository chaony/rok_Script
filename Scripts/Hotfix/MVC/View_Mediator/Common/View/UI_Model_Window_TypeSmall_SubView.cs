// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Model_Window_TypeSmall_SubView
...
namespace Game {
    public partial class UI_Model_Window_TypeSmall_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Model_Window_TypeSmall";

        public UI_Model_Window_TypeSmall_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_Window_TypeSmall;
        ...
        {       
			m_UI_Model_Window_TypeSmall = gameObject.GetComponent<RectTransform>();
			...
			m_btn_close_ButtonAnimation = FindUI<BtnAnimation>(gameObject.transform ,"bg/btn_close");
			...
			m_btn_back_ButtonAnimation = FindUI<BtnAnimation>(gameObject.transform ,"bg/btn_back");
