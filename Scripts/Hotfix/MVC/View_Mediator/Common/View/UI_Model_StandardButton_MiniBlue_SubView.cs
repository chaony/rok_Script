...
namespace Game {
    public partial class UI_Model_StandardButton_MiniBlue_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_MiniBlue";

        public UI_Model_StandardButton_MiniBlue_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_StandardButton_MiniBlue;
        ...
        {       
			m_UI_Model_StandardButton_MiniBlue = gameObject.GetComponent<RectTransform>();
