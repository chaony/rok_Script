...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_MiniRed";

        public UI_Model_StandardButton_MiniRed_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_StandardButton_MiniRed;
        ...
        {       
			m_UI_Model_StandardButton_MiniRed = gameObject.GetComponent<RectTransform>();
