...
namespace Game {
    public partial class UI_Model_StandardButton_Blue_SubView : UI_SubView
    {
        ...
        {       
			...
			m_img_redpointNum_PolygonImage = FindUI<PolygonImage>(gameObject.transform ,"btn_languageButton/img_redpointNum");

			m_lbl_num_LanguageText = FindUI<LanguageText>(gameObject.transform ,"btn_languageButton/img_redpointNum/lbl_num");
