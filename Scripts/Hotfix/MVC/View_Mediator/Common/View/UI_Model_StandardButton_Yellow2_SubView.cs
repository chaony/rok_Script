...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_Yellow2";

        public UI_Model_StandardButton_Yellow2_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public GrayChildrens m_UI_Model_StandardButton_Yellow2_GrayChildrens;
        ...
        {       
			m_UI_Model_StandardButton_Yellow2_GrayChildrens = gameObject.GetComponent<GrayChildrens>();
