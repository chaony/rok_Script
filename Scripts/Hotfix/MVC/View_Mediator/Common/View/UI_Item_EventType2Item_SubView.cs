...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Item_EventType2Item";

        public UI_Item_EventType2Item_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Item_EventType2Item;
        ...
        {       
			m_UI_Item_EventType2Item = gameObject.GetComponent<RectTransform>();
			...
			m_UI_Model_Item1 = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(gameObject.transform ,"pl_rewards/UI_Model_Item1"));
			m_UI_Model_Item2 = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(gameObject.transform ,"pl_rewards/UI_Model_Item2"));
			m_UI_Model_Item3 = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(gameObject.transform ,"pl_rewards/UI_Model_Item3"));
			m_UI_Model_Item4 = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(gameObject.transform ,"pl_rewards/UI_Model_Item4"));
			m_UI_Model_Item5 = new UI_Model_RewardGet_SubView(FindUI<RectTransform>(gameObject.transform ,"pl_rewards/UI_Model_Item5"));
			m_lbl_process_LanguageText = FindUI<LanguageText>(gameObject.transform ,"lbl_process");
			m_lbl_process_ArabLayoutCompment = FindUI<ArabLayoutCompment>(gameObject.transform ,"lbl_process");

			m_lbl_already_LanguageText = FindUI<LanguageText>(gameObject.transform ,"lbl_already");
			m_lbl_already_Shadow = FindUI<Shadow>(gameObject.transform ,"lbl_already");
			m_lbl_already_ArabLayoutCompment = FindUI<ArabLayoutCompment>(gameObject.transform ,"lbl_already");

			m_btn_go = new UI_Model_StandardButton_MiniBlue_SubView(FindUI<RectTransform>(gameObject.transform ,"btn_go"));
			m_btn_get = new UI_Model_StandardButton_MiniGreen_SubView(FindUI<RectTransform>(gameObject.transform ,"btn_get"));
