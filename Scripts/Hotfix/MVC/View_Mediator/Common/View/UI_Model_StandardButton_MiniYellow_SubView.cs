// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Model_StandardButton_MiniYellow_SubView
...
namespace Game {
    public partial class UI_Model_StandardButton_MiniYellow_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_MiniYellow";

        public UI_Model_StandardButton_MiniYellow_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_StandardButton_MiniYellow;
        ...
        {       
			m_UI_Model_StandardButton_MiniYellow = gameObject.GetComponent<RectTransform>();
