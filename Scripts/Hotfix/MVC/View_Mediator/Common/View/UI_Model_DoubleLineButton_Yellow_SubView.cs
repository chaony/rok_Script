...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_DoubleLineButton_Yellow";

        public UI_Model_DoubleLineButton_Yellow_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_DoubleLineButton_Yellow;
        ...
        {       
			m_UI_Model_DoubleLineButton_Yellow = gameObject.GetComponent<RectTransform>();
