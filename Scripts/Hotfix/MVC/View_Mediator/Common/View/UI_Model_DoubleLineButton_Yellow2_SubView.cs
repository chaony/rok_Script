...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_DoubleLineButton_Yellow2";

        public UI_Model_DoubleLineButton_Yellow2_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_DoubleLineButton_Yellow2;
        ...
        {       
			m_UI_Model_DoubleLineButton_Yellow2 = gameObject.GetComponent<RectTransform>();
