...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Item_ChargeSuperGiftItem2";

        public UI_Item_ChargeSuperGiftItem2_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Item_ChargeSuperGiftItem2;
        ...
        {       
			m_UI_Item_ChargeSuperGiftItem2 = gameObject.GetComponent<RectTransform>();
