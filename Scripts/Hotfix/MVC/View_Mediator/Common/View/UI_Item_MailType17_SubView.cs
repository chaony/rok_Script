// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Item_MailType17_SubView
...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Item_MailType17";

        public UI_Item_MailType17_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public VerticalLayoutGroup m_UI_Item_MailType17_VerticalLayoutGroup;
		[HideInInspector] public ViewBinder m_UI_Item_MailType17_ViewBinder;
        ...
        {       
			m_UI_Item_MailType17_VerticalLayoutGroup = gameObject.GetComponent<VerticalLayoutGroup>();
			m_UI_Item_MailType17_ViewBinder = gameObject.GetComponent<ViewBinder>();
