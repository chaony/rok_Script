// =============================================================================== 
// Author              :    Gen By Tools
// Class Description   :    UI_Model_StandardButton_Red_SubView
...
namespace Game {
    public partial class UI_Model_StandardButton_Red_SubView : UI_SubView
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_Red";

        public UI_Model_StandardButton_Red_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_StandardButton_Red;
        ...
        {       
			m_UI_Model_StandardButton_Red = gameObject.GetComponent<RectTransform>();
