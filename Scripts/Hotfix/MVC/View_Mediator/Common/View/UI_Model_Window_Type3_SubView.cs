...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_Window_Type3";

        public UI_Model_Window_Type3_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_Window_Type3;
        ...
        {       
			m_UI_Model_Window_Type3 = gameObject.GetComponent<RectTransform>();
