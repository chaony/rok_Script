...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_Blue2";

        public UI_Model_StandardButton_Blue2_SubView (RectTransform transform) 
        {
        ...
        #region gen ui code 
		[HideInInspector] public RectTransform m_UI_Model_StandardButton_Blue2;
        ...
        {       
			m_UI_Model_StandardButton_Blue2 = gameObject.GetComponent<RectTransform>();
