...
namespace Game {
    ...
    {
		public const string VIEW_NAME = "UI_Model_StandardButton_Yellow";

        public UI_Model_StandardButton_Yellow_SubView (RectTransform transform) 
        {
        ...
        {       
			m_UI_Model_StandardButton_Yellow = gameObject.GetComponent<RectTransform>();
