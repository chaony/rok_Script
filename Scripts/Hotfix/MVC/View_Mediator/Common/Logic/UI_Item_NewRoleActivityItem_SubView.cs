...
namespace Game {
    public partial class UI_Item_NewRoleActivityItem_SubView : UI_SubView
    {
        ...
        public Action<UI_Item_NewRoleActivityItem_SubView> BtnClickCallback;
        private ActivityScheduleData m_scheduleData;
        private int m_index;

        //刷新开服活动行为
        public void Refresh(int acEventId, ActivityScheduleData scheduleData)
        {
            ...
            //刷新按钮和进度
            RefreshProcessAndBtn(behaviorDefine, define.data0, define.data3);
        }
        ...
        //刷新进度和按钮显示
        private void RefreshProcessAndBtn(PlayerBehaviorDataDefine behaviorDefine, int data0, int data3)
        {
            //进度
        ...
        public void OnGo()
        {
            ActivityDaysTypeDefine define = CoreUtils.dataService.QueryRecord<ActivityDaysTypeDefine>(m_acEventId);
            if (define != null)
            {
                ...
                activityProxy.GoJump(define.jumpType);
            }
        }
    }
}