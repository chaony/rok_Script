...
namespace Game {
    public partial class UI_LC_Language_SubView : UI_SubView
    {
        ...
        public void SetLanguageAllianceId(int left, int right)
        {
            m_UI_Item_LanguageSelect1.SetLanguageAlliance(left);
            m_UI_Item_LanguageSelect2.SetLanguageAlliance(right);
        }
