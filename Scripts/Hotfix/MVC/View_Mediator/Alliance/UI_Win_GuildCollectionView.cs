...
// Class Description   :    UI_Win_GuildCollectionView
...
namespace Game {
    public class UI_Win_GuildCollectionView : GameView
    {
        public const string VIEW_NAME = "UI_Win_GuildCollection";

        public UI_Win_GuildCollectionView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_GuildCollectionMediator mt = new UI_Win_GuildCollectionMediator(vb.gameObject);
            mt.view = this;
