...
// Class Description   :    UI_Win_GuildLanguageView
...
namespace Game {
    public class UI_Win_GuildLanguageView : GameView
    {
        public const string VIEW_NAME = "UI_Win_GuildLanguage";

        public UI_Win_GuildLanguageView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_GuildLanguageMediator mt = new UI_Win_GuildLanguageMediator(vb.gameObject);
            mt.view = this;
