...
// Class Description   :    UI_Win_ReinforceView
...
namespace Game {
    public class UI_Win_ReinforceView : GameView
    {
        public const string VIEW_NAME = "UI_Win_Reinforce";

        public UI_Win_ReinforceView () 
        {
        }
        ...
        private void UIFinder()
        {
            ...
            UI_Win_ReinforceMediator mt = new UI_Win_ReinforceMediator(vb.gameObject);
            mt.view = this;
