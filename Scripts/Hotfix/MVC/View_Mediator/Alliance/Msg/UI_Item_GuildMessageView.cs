...
// Class Description   :    UI_Item_GuildMessageView
...
namespace Game {
    public class UI_Item_GuildMessageView : GameView
    {
		public const string VIEW_NAME = "UI_Item_GuildMessage";

        public UI_Item_GuildMessageView () 
        {
        }
        ...
        private void UIFinder(GameObject obj)
        {
			...
			m_lbl_date_ContentSizeFitter = FindUI<ContentSizeFitter>(vb.transform ,"lbl_date");
