...
namespace Client
{
    ...
    public class ImageCarousel : UIBehaviour, IEventSystemHandler, IBeginDragHandler, IInitializePotentialDragHandler, IDragHandler, IEndDragHandler, ICanvasElement
    {
        ...
        private void InitData()
        {
            ...
            {
                CellSize = GetComponent<RectTransform>().sizeDelta;
            }
        }
