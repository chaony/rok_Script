...
public class ArabLayoutCompment : MonoBehaviour{
    public enum ArabLayoutStyle
    {
        ...
        [ArabLayoutStyleEditor(typeof(LayoutGroup), "方向翻转")]
        ArabLayoutStyle_LayoutGroupFlipX = 0x400,
    }
    ...
    protected virtual bool UpdateArabLayout(ArabLayoutStyle style)
    {
        ...
        switch (style)
        {
            ...
            case ArabLayoutStyle.ArabLayoutStyle_NodeFlipX:
                ...
                return true;
            case ArabLayoutStyle.ArabLayoutStyle_RotateFlip:
                {
                    var compment = GetComponent<RectTransform>();
                    if (compment == null)
                        return false;

                    var rot = compment.transform.localEulerAngles;
                    rot.z = -rot.z;
                    compment.transform.localEulerAngles = rot;
                }
                return true;
            ...
            case ArabLayoutStyle.ArabLayoutStyle_GridLayoutGroupFlipX:
                ...
                return true;
            case ArabLayoutStyle.ArabLayoutStyle_LayoutGroupFlipX:
                {
                    var compment = GetComponent<LayoutGroup>();
                    if (compment == null)
                        return false;
                    switch (compment.childAlignment)
                    {
